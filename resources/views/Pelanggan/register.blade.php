    ...
    <div class="bg-white p-6 sm:p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-200 @error('name') border-red-500 @enderror">
                @error('name')
            ...
            <div>
                ...
                <input type="email" name="email" value="{{ old('email') }}" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-200 @error('email') border-red-500 @enderror">
                @error('email')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <div class="flex rounded border overflow-hidden focus-within:ring focus-within:ring-blue-200 @error('phone') border-red-500 @enderror">
                    ...
                    <input type="text" id="phone" name="phone" value="{{ old('phone') }}" maxlength="15" inputmode="numeric" pattern="[0-9]*" placeholder="Masukkan nomor WhatsApp aktif Anda" class="w-full px-3 py-2 focus:outline-none">
                </div>
                @error('phone')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <textarea name="address" rows="3" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-200 @error('address') border-red-500 @enderror">{{ old('address') }}</textarea>
                @error('address')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="relative">
                ...
                <input type="password" id="password" name="password" class="w-full border rounded px-3 py-2 pr-10 focus:outline-none focus:ring focus:ring-blue-200 @error('password') border-red-500 @enderror">
            ...
            <div class="relative">
                ...
                <input type="password" id="password_confirmation" name="password_confirmation" class="w-full border rounded px-3 py-2 pr-10 focus:outline-none focus:ring focus:ring-blue-200">
