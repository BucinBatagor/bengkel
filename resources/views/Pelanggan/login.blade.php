    ...
    <div class="bg-white p-6 sm:p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-4">
            ...
            <div class="relative">
                ...
                <span id="togglePassword" class="absolute top-[33px] right-3 cursor-pointer text-gray-500">
            ...
            <button type="submit" class="w-full bg-black text-white py-2 rounded hover:bg-gray-700 transition">Login</button>
        </form>
