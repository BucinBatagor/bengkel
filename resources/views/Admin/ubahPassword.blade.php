...
<section class="flex flex-col items-center px-6 py-6 w-full">
    <div class="bg-white rounded-lg shadow px-6 py-6 w-full">
        ...
        <form method="POST"
              action="{{ route('admin.profil.update-password') }}"
              class="space-y-4"
              novalidate>
            @csrf
            @method('PUT')
            ...
            {{-- Password Lama --}}
            <div>
                <label for="current_password" class="block font-semibold text-sm mb-1">
                    Password Lama
                </label>
                <div class="relative">
                    <input
            ...
            {{-- Password Baru --}}
            <div>
                <label for="password" class="block font-semibold text-sm mb-1">
                    Password Baru
                </label>
                <div class="relative">
                    <input
            ...
            <div>
                <label for="password_confirmation" class="block font-semibold text-sm mb-1">
                    Konfirmasi Password Baru
                </label>
                <div class="relative">
                    <input
