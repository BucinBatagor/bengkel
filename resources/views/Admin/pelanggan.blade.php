    ...
    <div class="flex justify-center mt-8">
        <ul class="inline-flex items-center text-sm">
            <div class="inline-flex space-x-1 mr-2">
                ...
                @else
                <li><a href="{{ $users->appends(request()->except('page'))->url(1) }}"
                        class="px-3 py-2 border rounded hover:bg-gray-200">&laquo;</a></li>
                <li><a href="{{ $users->appends(request()->except('page'))->previousPageUrl() }}"
            ...
            <div class="inline-flex space-x-1 ml-2">
                ...
                <li><a href="{{ $users->appends(request()->except('page'))->nextPageUrl() }}"
                        class="px-3 py-2 border rounded hover:bg-gray-200">&gt;</a></li>
                <li><a href="{{ $users->appends(request()->except('page'))->url($users->lastPage()) }}"
