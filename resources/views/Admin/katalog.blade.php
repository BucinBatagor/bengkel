            ...
            <table class="min-w-full border border-gray-300 text-sm text-left">
                <thead class="bg-black text-white uppercase text-xs tracking-wider">
                    <tr>
                        ...
                        <th class="px-5 py-3 border-r border-gray-400">
                            @php $nextOrder = request('sort') === 'harga' && request('order') === 'asc' ? 'desc' : 'asc'; @endphp
                ...
                <tbody class="text-gray-700">
                    ...
                    <tr class="hover:bg-gray-100 border-b border-gray-300">
                        ...
                        <td class="px-5 py-3 border-r border-gray-200">
                            @php $gambarUtama = $produk->gambar->firstWhere(fn($g) => !empty($g->gambar)); @endphp
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="text-center text-gray-500 py-10 text-base font-semibold">Belum ada produk yang tersedia.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
