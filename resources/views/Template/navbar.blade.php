            ...
            @if (Auth::check())
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open" x-cloak @click.away="open = false"
                        ...
                        <a href="/pesanan" class="block px-4 py-2 hover:bg-gray-100 text-sm font-medium rounded-md">Pesanan</a>
                        <a href="/riwayat" class="block px-4 py-2 hover:bg-gray-100 text-sm font-medium rounded-md">Riwayat Pesanan</a>
